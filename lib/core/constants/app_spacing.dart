...
class AppInsets {
  ...
  static const EdgeInsets aXs = EdgeInsets.all(xs);
  static const EdgeInsets aSm = EdgeInsets.all(sm);
  static const EdgeInsets aMd = EdgeInsets.all(md);
  static const EdgeInsets aLg = EdgeInsets.all(lg);
...
class AppRadius {
  ...
  static BorderRadius get allXs => const BorderRadius.all(Radius.circular(xs));
  static BorderRadius get allSm => const BorderRadius.all(Radius.circular(sm));
  static BorderRadius get allMd => const BorderRadius.all(Radius.circular(md));
  static BorderRadius get allLg => const BorderRadius.all(Radius.circular(lg));
  static BorderRadius get allXl => const BorderRadius.all(Radius.circular(xl));
}
